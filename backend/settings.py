...
SECRET_KEY = 'django-insecure-$r4la5il-m(p26nl1cn4-&ys045t@2ktncoe$2d(s$4@@sp#ym'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "BACKEND" / "TEMPLATES"], #تحديد مكان الصفحات
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD', 'AVNS_fH8QZsZ7Davi1QVuWMc'),
